package arcSoft.common;

public class Constants {

    public static final String APP_ID = "Fakr9nf8NWLpYYoMZ2eGS9ejjEoaKqxcNMbK7YHENyH4";
    public static final String SDK_KEY = "3BvpwWCyJ1BHhYA673Ui7f2MJMNDYxmnkXA4C6rwA1Xq";
