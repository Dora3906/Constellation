...
public class Fragment_Year extends Fragment {
    ...
    private static void initViews(View view) {
        ...
        tvDate.setText(fortune.getYear().get("date").toString());
        tvSummary.setText(fortune.getYear().get("summary").toString());
        tvMoney.setText(fortune.getYear().get("money").toString());
        tvCareer.setText(fortune.getYear().get("career").toString());
        tvLove.setText(fortune.getYear().get("love").toString());
    }
